...
def preprocess_qwen_1_5(
    ...
    assert conv.sep_style == conversation_lib.SeparatorStyle.QWEN_1_5
...
def preprocess(
    ...
    # fix: add qwen2
    if conversation_lib.default_conversation.version.startswith("qwen_1_5"):
        # print('--qwen_v2--')
        return preprocess_qwen_1_5(sources, tokenizer, has_image=has_image)
    # add end signal and concatenate together
    conversations = []
    for source in sources:
